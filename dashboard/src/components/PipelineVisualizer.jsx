/**
 * PipelineVisualizer.jsx -- Horizontal phase blocks with node dots
 */

import useProjectStore, { PIPELINE_PHASES, NODE_LABELS } from "../store/projectStore";
        ...
        <div className="pipeline">
            <div className="pipeline-track">
                {phases.map(([phaseKey, phase], phaseIdx) => {
                    ...
                    const phaseCompleted = phase.nodes.every((n) => completedNodes.includes(n));
                    const hasCompletedNode = phase.nodes.some((n) => completedNodes.includes(n));
                            ...
                            <div className={`phase-block ${phaseClass}`}>
                                ...
                                <div className="phase-dots">
                                    {phase.nodes.map((nodeName) => {
                                        ...
                                        return (
                                            <div key={nodeName} className={`phase-dot ${dotClass}`} title={NODE_LABELS[nodeName] || nodeName}>
