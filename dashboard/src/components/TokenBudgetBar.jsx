...
export default function TokenBudgetBar() {
    ...
    return (
        <div className="token-bar">
            ...
            <span className="token-bar-cost">${cost.toFixed(4)} / ${tokenBudget.toFixed(2)}</span>
            <span className="token-bar-meta">{callCount} calls &middot; {totalTokens.toLocaleString()} tok</span>
        </div>
    );
}
