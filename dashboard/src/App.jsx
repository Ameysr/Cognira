/**
 * App.jsx -- Cognira Mission Control Dashboard
 * Industrial dark UI. Clean typography. No emojis.
 */
...
export default function App() {
    ...
    const handleCancel = useCallback(() => { sendMessage({ type: "cancel" }); }, [sendMessage]);
    ...
    const handleNewProject = useCallback(() => { disconnect(); reset(); }, [disconnect, reset]);
            ...
            <header className="header">
                <div className="header-left">
                    <div className="logo">
                        ...
                        <span className="logo-text">COGNIRA</span>
                    </div>
                ...
                <div className="header-right">
                    ...
                    {projectId && (
                        <button className="btn btn-text" onClick={handleNewProject}>NEW PROJECT</button>
                    )}
                </div>
            </header>
                        ...
                        <div className="landing-inner">
                            <div className="landing-left">
                                ...
                                <p className="landing-desc">
                                    28 specialized agents -- PM, Architect, Planner, Coder,
                                    Reviewer, Executor, Debugger -- working in concert.
                                    From a single sentence to a working application.
                                </p>
                            </div>
                    ...
                    <div className="dashboard">
                        <div className="req-bar">
                            ...
                            <div className="req-bar-right">
                                ...
                                {status === "running" && (
                                    <button className="btn btn-text btn-sm" onClick={handleCancel}>ABORT</button>
                                )}
                                {status === "error" && errorRecoverable && (
                                    <button className="btn btn-accent btn-sm" onClick={handleResume}>RETRY</button>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="dashboard-grid">
                            <div className="dashboard-col"><LogStream /></div>
                            <div className="dashboard-col"><OutputPanel /></div>
                        </div>

                        {humanInputRequest && (
                            <HumanInputPanel request={humanInputRequest} onSubmit={handleHumanResponse} />
                        )}
