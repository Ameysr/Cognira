 ...
 *
 * Each connection is tied to a project via ws://server/ws?projectId=xxx
 *
 * Server -> Client: node_complete, human_input_needed, token_update, run_complete
 * Client -> Server: human_response, cancel, ping
 */
