/**
 * setupSandbox.js -- Creates project workspace + scaffold files
 *
 * Passes the Architect's blueprint (folder structure, dependencies, DB schema)
 * to sandboxManager. Also seeds the file registry with scaffold file interfaces
 * so the Coder knows exactly how to import them.
 *
 * Zero LLM calls.
 */
