 ...
 *
 * The Coder writes code, but LLMs make mistakes.
 * The Reviewer catches these BEFORE execution, saving expensive debug cycles.
 *
 * MAX 2 REJECTION CYCLES:
 * If reviewer rejects 3 times, the task goes to simplifyTask.
 */
...
/**
 * Router: approved -> executor, rejected (<=2) -> contextBuilder, rejected (>2) -> simplifyTask
 */
