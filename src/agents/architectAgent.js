 ...
 * The state reducer accumulates these deltas.
 */

import { callLLM, makeTokenDelta } from "../utils/llm.js";
...
export async function architectStep1Node(state) {
    console.log("\n[Architect Step 1/5] Identifying entities & relationships...\n");
...
export async function architectStep5Node(state) {
    console.log("\n[Architect Step 5/5] Generating folder structure & dependencies...\n");
